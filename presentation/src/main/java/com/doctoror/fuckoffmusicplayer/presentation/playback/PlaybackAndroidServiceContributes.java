...
@Module
public interface PlaybackAndroidServiceContributes {

    @ServiceScope
    @ContributesAndroidInjector(modules = {PlaybackServiceModule.class})
    PlaybackAndroidService playbackAndroidService();
}
