...
public interface PlaybackDataProto {
  ...
  public static final class PlaybackData extends
    ...
    public PlaybackDataProto.Media[] queue;
    ...
    public PlaybackData clear() {
      queue = PlaybackDataProto.Media.emptyArray();
      queuePosition = 0;
      mediaPosition = 0L;
      cachedSize = -1;
      return this;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.queue != null && this.queue.length > 0) {
        for (int i = 0; i < this.queue.length; i++) {
          PlaybackDataProto.Media element = this.queue[i];
          if (element != null) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            PlaybackDataProto.Media[] newArray =
                new PlaybackDataProto.Media[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.queue, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new PlaybackDataProto.Media();
